...
export const UserBookDetail = () => {
  ...
  user:{getUserInfo}
    ...
    const [sportBookAllData, setSportAllBookData] = useState([])
  ...
  const loadSportBookData = async() => {
    ...
    if(matchId){
      ...
      if(res?.results?.length){
        ...
        setSportAllBookData(res?.results)
      }
    }
  }
  ...
  return (
    <div className={style.mainWrapper}>
        <TitleBarUpdated title={eventName?.tennis || ''} isButton={true} btnTitle={'Refresh'}/>
