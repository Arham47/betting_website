...
export const CAMEL_MARKET_ID_PARAM_KEY="marketId" 

//// Initial Value Constant ////
export const INITIAL_NUM_RECORDS = 10
export const INITIAL_PAGE_NUMBER  = 1
export const INITIAL_LIMIT  = 10
export const INITIAL_QUERY_PARAM = `?${LOWER_PAGE_PARAM_KEY}=${INITIAL_PAGE_NUMBER}&${LOWER_NUM_RECORDS_PARAM_KEY}=${INITIAL_NUM_RECORDS}&${LOWER_LIMIT_PARAM_KEY}=${INITIAL_LIMIT}`



//// Table Constant

export const CAMEL_CREDIT_REMAINING = "Credit Remaining";	
export const CAMEL_CREDIT_RECEIVED = "Credit Received";
export const CAP_PL_DOWNLINE = "P/L Downline";
export const CAP_BALANCE_UPLINE = "Balance UpLine";	
export const CAP_GAME = "Game";
export const CAP_BET_AMOUNT = "Bet Amount";
export const CAP_BET_RATE = "Bet Rate";
export const CAP_BETING_TIME = "Beting Time";
...
export const CAP_ALL_RULES = "All Casino Rules"
export const CAP_VERY_IMPORTANT= "Very Important";
export const CAP_NOT_AGREE="No, I’m not agree";
export const CAP_AGREE = "Yes, I’m agree";
...
export const CAMEL_AMOUNT_IN_PKR = "Amount in PKR"
...
export const CAMEL_ISBETTER = "isBetter"
...
export const CAP_CHANGE_TERM_AND_CONDITION= "Change Term and Privacy Policy"
export const LOWER_ACTIVE = "active";
export const CAP_IN_ACTIVE = "In Active";
export const CAMEL_ISACTIVE = "isActive";
export const CAP_SETTLED = "Settled"
export const LOWER_SETTLED = "settled"
export const CAP_VOIDED = "Voided"
export const LOWER_VOIDED = "voided"
export const CAP_CANCELLED = "Cancelled"
export const LOWER_CANCELLED = "cancelled"
...
export const CAP_ALL_USERS = "All Users";
export const CAMEL_ALL_USERS = "allUsers"
export const CAP_SELECTED_USERS = "Selected Users";
export const CAMEL_SELECTED_USERS = "selectedUsers"
export const CAP_UNLOCK_ALL = "Unlock All"
export const CAMEL_UNLOCK_ALL = "unlockAll"
...
export const CAMEL_ENTER_VALUES = "Enter Values";
...
export const CAP_LOADING_DOT_DOT_DOT = "Loading..."
export const CAP_CHANGE_TERMS_AND_CONDITION= "Change Terms And Condition"
export const CAP_BET_HISTORY = "Bets History"
export const CAP_ALL = "All"
export const LOWER_ALL = "all"
export const CAP_THEME_SETTing= "Theme Setting"
export const CAP_ChANGE_PRIVACY = "Privacy Policy"
export const CAP_TERMS_AND_CONDITIONS_CHANGE= " Terms & Condition"
export const CAP_UPDATE_BETSIZE = " Bet Size Limits"
export const CAP_UPDATE_CURRENCY = " Exchange Rates"
export const  CAP_CHANGE_DEFAULT_LOGIN = "Change Default Login Page"
export const CAP_CHANGE_DEFAULT_THEME = "Change Default Theme"
export const CAP_TITLE = "Title"
export const CAP_EVENTID = "EventID"
export const CAP_LIVE = "LIVE"
export const CAP_SERIES_FULL_NAME = "Series Full Name"
export const CAP_MATCH_FULL_NAME = "Match Full Name"
//// Button Title Constants ////**
export const CAP_ACCEPT_BTN_TITLE = "Accept"
export const CAP_SAVE_BTN_TITLE = "SAVE"
export const CAP_CONFIRM_BTN_TITLE = "Confirm"
export const CAP_SUBMIT_BTN_TITLE =  "Submit"
export const CAP_DECLINE_BTN_TITLE = "Decline"
export const CAP_CANCEL_BTN_TITLE = "Cancel"
export const CAP_BET_LOCK_BTN_TITILE = "Bet Lock";
export const CAP_CLOSE_BTN_TITLE = "Close"


//// Constants for Company Settings Only  ////
...
export const LOWER_LOGIN_PAGE_ONE = "login-page-one"
export const LOWER_LOGIN_PAGE_TWO = "login-page-two"
export const LOWER_LOGIN_PAGE_THREE = "login-page-three"
export const CAMEL_DEFAULT_LOGIN_PAGE = "defaultLoginPage"
export const BET_DELAY_NUMBER = 4